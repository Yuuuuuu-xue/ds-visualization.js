...
$(document).ready(function() {
  ...
  dsController.setCurrentGraphTitle('Example of a graph')
  dsController.pushVertexToCurrentGraph('1', 'First Vertex', 50, 50);
  dsController.pushVertexToCurrentGraph('2', 'Second Vertex', 200, 300);
  dsController.pushVertexToCurrentGraph('3', 'Third Vertex', 300, 200);
  dsController.pushVertexToCurrentGraph('4', 'Fourth Vertex', 500, 200);
  dsController.pushVertexToCurrentGraph('5', 'Fifth Vertex', 750, 50);
  dsController.pushVertexToCurrentGraph('6', 'Sixth Vertex', 460, 350);
  dsController.pushEdgeToCurrentGraph('4', '5');
  dsController.pushEdgeToCurrentGraph('3', '5')
  dsController.pushEdgeToCurrentGraph('1', '3');
  dsController.pushEdgeToCurrentGraph('2', '1');
  dsController.pushEdgeToCurrentGraph('4', '3');
  dsController.pushEdgeToCurrentGraph('1', '2');
  dsController.pushEdgeToCurrentGraph('3', '6');
  dsController.createGraph('test', 'Next Graph');
  dsController.moveNextGraph();
  dsController.pushVertexToCurrentGraph('1', 'New First Vertex', 200, 200);
  dsController.movePrevGraph();
  dsController.setDialogWidth(250);
  dsController.setDialogHeight(400);
